...
<g:sortableColumn property="realizada" title="${message(code: 'atividade.realizada.label', default: 'Realizada')}" />
...
<td><g:checkBox name="realizada" value="${false}" /></td>					
					</tr>

<tr>

<td><g:submitButton name="update" value="Update" />
</td>
</tr>			</g:each>
				</tbody>
			</table>
